...
export const [titleTypewriterSpeedContainerEl, titleTypewriterSpeedInputEl] = getContainerAndInput("title-typewriter-speed");
export const [titleTypewriterRemainCountContainerEl, titleTypewriterRemainCountInputEl] = getContainerAndInput("title-typewriter-remain-count");
...
export const wallpaperResetAllButtonEl = getButton("wallpaper-reset-all");
...
export const bookmarksEnablePaginationCheckboxEl = getCheckbox("bookmarks-enable-pagination");
export const [bookmarksMaxBookmarkRowsPerPageContainerEl, bookmarksMaxBookmarkRowsPerPageInputEl] = getContainerAndInput("bookmarks-max-bookmark-rows-per-page");
...
export const [bookmarksDefaultIconColorContainerEl, bookmarksDefaultIconColorInputEl] = getContainerAndInput("bookmarks-default-icon-color");
