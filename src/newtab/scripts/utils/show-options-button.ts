...
export const showOptionsButton = (showOptionsButton: boolean, uiStyle: UIStyle, animationsEnabled: boolean, animationsInitialType: AnimationInitialType, textColor: string) => {
